...
try:
    ...
    from src.langgraph.workflows.sic_prediction_workflow import SICPredictionWorkflow
    from src.apis.companies_house_client import create_companies_house_client
    from src.apis.web_scraper import create_web_scraper
...
class Phase2Integration:
    ...
    def scrape_company_website(self, company_name: str, website_url: Optional[str] = None) -> Dict[str, Any]:
        ...
        if self.use_real_agents and self.web_scraper:
            ...
            from src.apis.web_scraper import MockWebContentScraper
