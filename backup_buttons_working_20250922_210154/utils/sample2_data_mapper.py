...
def load_and_map_sample_data(csv_path: str = "data/Sample_data2.csv") -> pd.DataFrame:
    ...
    try:
        ...
        print(f"✅ Successfully loaded and mapped {len(mapped_df)} rows from {csv_path}")
...
if __name__ == "__main__":
    ...
    if not df.empty:
        ...
        print(df[Sample2DataMapper.get_key_columns_for_streamlit()].head(3))
        
        print(f"\n📋 Available SIC columns:")
