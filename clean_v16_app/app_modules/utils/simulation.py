...
# Conditional numpy import for Azure compatibility
try:
    import numpy as np
    NUMPY_AVAILABLE = True
except ImportError:
    # Create a mock numpy for demo purposes when numpy is not available
    class MockNumpy:
        @staticmethod
        def random():
            class MockRandom:
                ...
                def normal(loc, scale):
                    # Simple approximation using built-in random
...
class SimulationService:
    ...
    def generate_sic_accuracy(self, count: int):
