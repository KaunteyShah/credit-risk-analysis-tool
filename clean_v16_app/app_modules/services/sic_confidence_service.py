...
# Add project root and batch/ folder to path so auto_sic_confidence_calculator is found
_project_root = Path(__file__).parent.parent.parent
sys.path.insert(0, str(_project_root))
sys.path.insert(0, str(_project_root / "batch"))
...
try:
    ...
    raise ImportError(
        "auto_sic_confidence_calculator not found. "
        f"Expected at: {_project_root / 'batch' / 'auto_sic_confidence_calculator.py'}"
    )
