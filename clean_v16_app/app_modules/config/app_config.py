...
class CreditRiskConfig:
    ...
    def __init__(self, project_root: Optional[Path] = None):
        ...
        # Legacy CSV predictions file removed - now using SQLite database
    ...
    def _is_running_in_container(self) -> bool:
        ...
        try:
            ...
            # Handle any permission errors or missing paths gracefully
    ...
    def _resolve_database_path(self) -> str:
        ...
        # Environment-specific defaults - use credit_risk.db for all environments
        # since that's where our actual data is located
